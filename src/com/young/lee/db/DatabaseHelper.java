...
import com.young.lee.dao.BaseEntity;
...
public class DatabaseHelper extends OrmLiteSqliteOpenHelper {
	 ...
	 * @return
	 */
	public static synchronized DatabaseHelper gainInstance(Context context,
			String dbName, int version) {
		if (instance == null) {
			databaseName = dbName;
			databaseVersion = version;
			// 会隐式调用public DatabaseHelper(Context context){}
			instance = OpenHelperManager.getHelper(context,
	...
	public void clearTableData(Class<? extends BaseEntity> entity) {
		try {
			...
			Log.e(TAG,
					"Unable to clear table data for -->"
							+ entity.getSimpleName(), e);
		}
	}
	...
	public DatabaseConnection getConnection() throws SQLException {
		...
		if (isOpen()) {
			...
			connection = new AndroidDatabaseConnection(getWritableDatabase(),
					true);
		}
		return connection;
	}
