...
/**
 * 重写让ScrollView有滚动监听(23以前是没有滚动监听的) 拦截touch事件，让其支持下拉放大图片 Created by Raye on
 * 2016/6/11. <br>
 * http://raye.wang/2016/06/13/zi-ding-yi-kong-jian-zhi-zhong-xie-
 * scrollviewshi-xian/
 */
public class ZoomScrollView extends ScrollView {
	...
	private void init(AttributeSet attrs) {
		...
		maxZoom = t.getDimensionPixelOffset(
				R.styleable.ObservableScrollView_maxZoom, 0);
		t.recycle();
	}
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			LinearLayout.LayoutParams lp = (LinearLayout.LayoutParams) zoomView
					.getLayoutParams();
	...
	public interface ScrollViewListener {
		void onScrollChanged(ZoomScrollView scrollView, int x, int y, int oldx,
				int oldy);
	}
}